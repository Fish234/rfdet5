...
class MarkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post markers_url, params: { marker: { category_id: @marker.category_id, name: @marker.name, type_id: @marker.type_id } }
    end
  ...
  test "should update marker" do
    patch marker_url(@marker), params: { marker: { category_id: @marker.category_id, name: @marker.name, type_id: @marker.type_id } }
